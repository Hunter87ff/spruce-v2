            ...
            <div className="container mx-auto py-20 w-full">
                ...
                <div className="text-center bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-12">
                    ...
                    <div className="flex justify-center gap-4">
                        <button className="bg-white border-2 border-transparent border-blue-500 text-indigo-900 font-bold py-3 px-8 rounded-full hover:bg-gray-800 hover:text-white hover:bg-purple-700 transition-all">
                            Get Started
                        </button>
