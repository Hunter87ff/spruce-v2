            ...
            <div className="container mx-auto py-20 w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
                    {features.map((feature, index) => (
                        <div key={index} className="p-6 rounded-xl bg-gray-800/50 backdrop-blur-sm hover:bg-gray-600 transition-all">
                            <div className="mb-4">
                                {feature.icon}
                            </div>
                ...
                <div className="text-center bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-12">
                    ...
                    <div className="flex justify-center gap-4">
                        <button className="bg-white border border-blue-500 text-indigo-900 font-bold py-3 px-8 rounded-full hover:bg-gray-100 transition-all">
                            Get Started
                        </button>
