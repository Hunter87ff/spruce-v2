...
export const CLIENT_ID = 931202912888164474n;
export const INVITE_URL = `https://discord.com/oauth2/authorize?client_id=${CLIENT_ID}&permissions=8&scope=bot&guild_id=`

export const API_ROUTE =  import.meta.env.VITE_API_ROUTE ||"/api";
export const AUTH_URL = import.meta.env.VITE_AUTH_URL || `https://discord.com/oauth2/authorize?client_id=${CLIENT_ID}&response_type=code&redirect_uri=${location.origin}/api/auth/callback&scope=guilds+identify`;
